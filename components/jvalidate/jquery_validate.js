...
$.extend($.validator, {
	...
	prototype: {
		...
		showLabel: function(element, message) {
			...
			if ( label.length ) {
				...
				// create label
				label = $("<" + this.settings.errorElement + " id='error_jvalidate' />")
	...
	methods: {
        ...
        /************************************************************/ 
		//Fecha: 15/11/2013. Cambio realizado: Fix validador => añadir ñ al validador de letras, Ln 1099. 
		//Fecha: 18/11/2013. Cambio realizado: Fix validador => añadir letras acentuadas (áéíóú) y sus correspondientes mayúsculas (ÁÉÍÓÚ), Ln 1100
        lettersonly: function(value, element) {
                
            var str = "";    
            str = value.replace(/\s/g,'');
            return this.optional(element) || /^[a-zñÑáéíóúÁÉÍÓÚ]+$/i.test(str);
        }
